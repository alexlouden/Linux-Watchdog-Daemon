...
# for make dist... :(
EXTRA_DIST = $(man_MANS) include examples ChangeLog watchdog.lsm 		watchdog.conf rc.watchdog.debian rc.watchdog.redhat
...
installdirs-am:
	$(mkinstalldirs)  $(DESTDIR)$(mandir)/man5 $(DESTDIR)$(mandir)/man8
